...
input_dir_path = '/Volumes/MISR_REPO/MISR_root' # '/Volumes/MISR_REPO/MISR_root/' # path to hdf files reflectance (GRP_ELLIPSOID) files, where we downloaded files
input_dir_name = 'misr_dl_test'
output_dir_path = input_dir_path 
output_dir_name = 'toa_test' # output of TOA run
